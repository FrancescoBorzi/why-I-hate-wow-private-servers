...
Таким образом, частные серверы достигли такого качества только благодаря большому комьюнити, 
которые внедряли все больше и больше игровых возможностей на протяжении многих лет (с 2005 года по сегодняшний день).
...
Без него вы бы не написали даже процедуру входа на сервер в самом начале.
...
*Примечание: качество (конкуренция) между частными серверами должно быть не только исправность, а также другими факторами, такими как умение их администраторов управлять ими.
Качество сообщества также играет фундаментальную роль, как и в случае с серверами Blizzard (которые с технической точки зрения все равны)*.
...
Вы увидите, кто-то что-нибудь сделал. Вы увидите все строки кода, их авторов, комментарии других разработчиков и так далее. 
